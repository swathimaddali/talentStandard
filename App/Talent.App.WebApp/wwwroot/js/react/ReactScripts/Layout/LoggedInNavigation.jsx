...
export class LoggedInNavigation extends React.Component {
    ...
    isUserAuthenticated() {
        ...
        console.log("LoggedInNavigation::: talentAuthToken" + cookies);
        $.ajax({
            url: 'http://localhost:60290/profile/profile/isUserAuthenticated',
            //url: 'https://talentservicesprofile3.azurewebsites.net/profile/profile/isUserAuthenticated',
    ...
    render() {
        ...
        console.log("this.props.role.toLowerCase()"+this.props.role.toLowerCase());
        let navdata = [];
        switch (userType) {
            case 'employer':
                navdata = empData
