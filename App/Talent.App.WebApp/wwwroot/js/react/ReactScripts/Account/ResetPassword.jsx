...
export default class ResetPassword extends React.Component {
    ...
    checkToken(email, token) {
      ...
      // let url = `http://localhost:60998/authentication/authentication/verifyResetPasswordToken?o=${email}&p=${token}`;
        let url = `https://talentservicesidentity2.azurewebsites.net/authentication/authentication/verifyResetPasswordToken?o=${email}&p=${token}`;
        $.ajax({
            url: url,
            type: 'POST',
    ...
    savePassword() {
       ...
       // let resetUrl = `http://localhost:60998/authentication/authentication/resetpassword?o=${email}&p=${token}`;
        let resetUrl = `https://talentservicesidentity2.azurewebsites.net/authentication/authentication/resetpassword?o=${email}&p=${token}`;
        $.ajax({
            url: resetUrl,
            type: 'POST',
