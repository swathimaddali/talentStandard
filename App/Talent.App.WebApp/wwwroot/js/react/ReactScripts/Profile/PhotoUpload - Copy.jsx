...
export default class PhotoUpload extends Component {
    ...
    */
    ...
    render() {
        ...
        if (show)
            upload = <div> <Button color="black" onClick={this.fileUpload}>Upload <Icon name='upload' /><a href={path} download/></Button></div>
        let showProfileImg = [];
        if (this.state.newFile == "") {
            ...
            showProfileImg.push(<span><img style={{ height: 112, width: 112, borderRadius: 55 }} className="ui medium" src={this.state.newFile.name} alt="Image Not Found" onClick={this.selectFileToUpload} /></span>);
        return (
