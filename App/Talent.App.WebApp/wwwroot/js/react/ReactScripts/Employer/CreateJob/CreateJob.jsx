...
export default class CreateJob extends React.Component {
    ...
    loadData() {
        ...
        console.log("param" + param + "copyJobParam" + copyJobParam);
        if (param != "" || copyJobParam != "") {
           ...
           var link = param != "" ? 'https://talentservicestalent3.azurewebsites.net/listing/listing/GetJobByToEdit?id=' + param
                : 'https://talentservicestalent3.azurewebsites.net/listing/listing/GetJobForCopy?id=' + copyJobParam;
    ...
    addUpdateJob() {
        ...
        $.ajax({
          //  url: 'http://localhost:51689/listing/listing/createUpdateJob',
            url: 'https://talentservicestalent3.azurewebsites.net/listing/listing/createUpdateJob',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
